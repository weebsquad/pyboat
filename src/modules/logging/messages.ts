...
export const messages: {[key: string]: {[key: string]: string}} = {
  ...
  '|ADMIN': {
    ...
    LOCKED_CHANNEL: `${discord.decor.Emojis.LOCK} _ACTORTAG_ locked <#_CHANNEL_ID_>_DURATION__REASON_`,
    UNLOCKED_CHANNEL: `${discord.decor.Emojis.UNLOCK} _ACTORTAG_ unlocked <#_CHANNEL_ID_>_REASON_`,
    LOCKED_GUILD: `${discord.decor.Emojis.LOCK} _ACTORTAG_ locked the server_DURATION__REASON_`,
  ...
  'GUILD_MEMBER_UPDATE': {
    ...
    AVATAR_ADDED: `${discord.decor.Emojis.FRAME_PHOTO} _USERTAG_ added avatar`,
    AVATAR_REMOVED: `${discord.decor.Emojis.FRAME_PHOTO} _USERTAG_ removed their avatar`,
    AVATAR_CHANGED: `${discord.decor.Emojis.FRAME_PHOTO} _USERTAG_ changed their avatar`,
  ...
  'GUILD_UPDATE': {
    NAME_CHANGED: 'server name changed from `_OLD_NAME_` to `_NEW_NAME_`',
    REGION_CHANGED: 'server region changed from **_OLD_REGION_** to **_NEW_REGION_**',
    DESCRIPTION_CHANGED: 'server description changed from `_OLD_DESC_` to `_NEW_DESC_`',
    DMN_CHANGED: 'server default message notifications changed from **_OLD_DMN_** to **_NEW_DMN_**',
    EXPLICIT_FILTER_CHANGED: 'server explicit content filter changed from **_OLD_FILTER_** to **_NEW_FILTER_**',
    VERIFICATION_LEVEL_CHANGED: 'server verification level changed from **_OLD_LEVEL_** to **_NEW_LEVEL_**',
...
export const messagesAuditLogs: {[key: string]: {[key: string]: string}} = {
  ...
  GUILD_UPDATE: {
    ...
    BANNER_ADDED: '_ACTORTAG_ added server banner',
    BANNER_REMOVED: '_ACTORTAG_ removed server banner',
    BANNER_CHANGED: '_ACTORTAG_ changed server banner to',
    ICON_ADDED: '_ACTORTAG_ added server icon',
    ICON_REMOVED: '_ACTORTAG_ removed server icon',
    ICON_CHANGED: '_ACTORTAG_ changed server icon',
    ...
    SPLASH_ADDED: '_ACTORTAG_ added server splash',
    SPLASH_REMOVED: '_ACTORTAG_ removed server splash',
    SPLASH_CHANGED: '_ACTORTAG_ changed server splash',
  ...
  VOICE_STATE_UPDATE: {
    SERVER_DEAFENED:
      ...
      } _ACTORTAG_ server deafened _USERTAG_ in _CHANNEL_MENTION_ **[**||\`_CHANNEL_ID_\`||**]**`,
    SERVER_UNDEAFENED:
      `${discord.decor.Emojis.SPEAKER
      } _ACTORTAG_ server undeafened _USERTAG_ in _CHANNEL_MENTION_ **[**||\`_CHANNEL_ID_\`||**]**`,
    SERVER_MUTED:
      `${discord.decor.Emojis.MICROPHONE2
      } _ACTORTAG_ server muted _USERTAG_ in _CHANNEL_MENTION_ **[**||\`_CHANNEL_ID_\`||**]**`,
    SERVER_UNMUTED:
      `${discord.decor.Emojis.MICROPHONE2
      } _ACTORTAG_ server unmuted _USERTAG_ in _CHANNEL_MENTION_ **[**||\`_CHANNEL_ID_\`||**]**`,
    LEFT_CHANNEL:
