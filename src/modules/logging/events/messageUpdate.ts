...
export function getKeys(
  ...
  if (message.guildId === null) {
    // dms
    if (message.content !== oldMessage.content) ret.push('dmMessageContent');
  } else {
    if (message.content !== oldMessage.content) ret.push('guildMessageContent');
  }
  return ret;
}

export const messages = {
  guildMessageContent: async function(
    log: discord.AuditLogEntry,
  ...
  dmMessageContent: async function(
    log: discord.AuditLogEntry,
    message: discord.Message,
