...
export function getKeys(
  ...
  if (ev.guildId) {
    if (
      ...
      return []; // user was banned so lets not bother with logging stuff
    if (msg === null) return ['messageDeletedGuildNoCache'];
    if (msg.webhookId !== null) return ['messageDeletedGuildWebhook'];
    return ['messageDeletedGuild'];
  } else {
    if (msg === null) return ['messageDeletedNoCache'];
...
export const messages = {
  ...
  messageDeletedGuild: async function(
    log: discord.AuditLogEntry,
    ev: discord.Event.IMessageDelete,
  ...
  messageDeletedGuildWebhook: function(
    log: discord.AuditLogEntry,
    ev: discord.Event.IMessageDelete,
    msg: discord.Message
  ) {
  ...
  messageDeletedNoCache: function(
    log: discord.AuditLogEntry,
    ev: discord.Event.IMessageDelete
  ) {
    let mp = new Map();
  ...
  messageDeletedGuildNoCache: function(
    log: discord.AuditLogEntry,
    ev: discord.Event.IMessageDelete
  ) {
    let mp = new Map();
