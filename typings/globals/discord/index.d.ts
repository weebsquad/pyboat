  ...
  namespace interactions {
    ...
    namespace commands {
      ...
      class SlashCommandInteraction {
        ...
        /**
         * Manually acknowledges an interaction, optionally overriding the default behavior set in [[ICommandConfig.showSourceMessage]].
         *
         * Throws an exception if the interaction was previously acknowledged!
         *
         * Note: If used, this method must be called within ~2.5 seconds of the interaction being received.
         * Otherwise, the command will be acknowledged automatically with the default setting.
         *
         * @param showSourceMessage (optionally) overrides the default message behavior. If true, the original source message will be shown.
         */
       ...
       *
       * If this new command contains no sub-commands, you may specify a handler to act on any incoming executions of the command.
       *
